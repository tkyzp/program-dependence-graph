; ModuleID = 'example/minitest.c'
source_filename = "example/minitest.c"
...
@.str.9 = private unnamed_addr constant [19 x i8] c"example/minitest.c\00", section "llvm.metadata"
@llvm.global.annotations = appending global [1 x { ptr, ptr, ptr, i32, ptr }] [{ ptr, ptr, ptr, i32, ptr } { ptr @key, ptr @.str.8, ptr @.str.9, i32 5, ptr null }], section "llvm.metadata"
